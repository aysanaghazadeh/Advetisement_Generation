...
llama_file = json.load(open('/Users/aysanaghazadeh/experiments/results/llama3_ppo_generated_description_8000steps_test_setGPT4v_persuasiveness_alignment.json_SDXL_20240623_141219GPT4v_persuasiveness_alignment.json'))
...
for filename in list(llama_file.keys())[0:1041]:
