...
llama_file = json.load(open('/Users/aysanaghazadeh/experiments/results/simple_llava_description_large_train_set_persuasiveness.json_SDXL_train_images_20240614_174659_persuasiveness.json'))
